...
namespace SIMEA.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<IdentityExtendUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new IdentityExtendUser { UserName = Input.Email, Email = Input.Email, FullName = Input.FullName, AccountStatus = "Disable", EmailConfirmed = true };
